...
export function BeamMark({
  ...
  return <svg viewBox="75 75 590 590" fill="none" className={className} aria-hidden="true">{sculptural ? <><defs><linearGradient id={`${id}face`} x1="190" y1="140" x2="490" y2="580" gradientUnits="userSpaceOnUse"><stop stopColor="#fff" /><stop offset=".23" stopColor="#ddf7ff" /><stop offset=".44" stopColor="#7ccaff" /><stop offset=".53" stopColor="#eefcff" /><stop offset=".7" stopColor="#409ded" /><stop offset="1" stopColor="#beeaff" /></linearGradient><linearGradient id={`${id}edge`} x1="180" y1="180" x2="480" y2="600" gradientUnits="userSpaceOnUse"><stop stopColor="#eefcff" /><stop offset=".5" stopColor="#448bd4" /><stop offset="1" stopColor="#1762aa" /></linearGradient></defs>{Array.from({
        length: 18
